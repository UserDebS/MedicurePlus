...
const ShopRegisterForm = () => {
    ...
    return (
        <form className="h-full w-full p-2" onSubmit={handleSubmit}>
            <h1 className="font-bold text-4xl text-white">Register as a shop</h1>
            ...
            <br />
            <p className="m-0 p-0 border-0 font-bold text-white"><strong>Already have an account? Go to Shop Login!</strong></p>
            <br />
            <Button
